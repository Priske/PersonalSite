  ...
  return (
    <section className="home-hero" id="about">
      <div className="home-hero__identity">
        <p className="section-banner">{config.heroBanner}</p>
        ...
        <p className="home-hero__location">{config.heroRole}</p>
      </div>
      ...
      <div className="home-hero__content">
        ...
        <div className="home-hero__copy">
          <p className="home-hero__eyebrow">{config.heroEyebrow}</p>

          <h2>{config.heroHeading}</h2>

          <p className="home-hero__summary">{config.heroSummary}</p>
