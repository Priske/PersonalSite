    ...
    <main className="user-list-page">
      <section className="user-list-page__intro">
        ...
        <p className="user-list-page__intro-text">
          Search, review and manage registered user
          accounts.
        </p>
      </section>
      ...
      <section className="user-list-page__content">
        <span
          className="user-list-page__connector"
          aria-hidden="true"
        >
        ...
        <article className="user-list-card">
          <header className="user-list-card__header">
            <div>
              <p className="user-list-card__eyebrow">
                Users
              </p>
          ...
          <div className="user-list-card__body">
            ...
            {search && (
              <div className="user-list-card__filter">
                ...
                <Link
                  className="user-list-card__clear"
                  to="/users"
                >
                  Clear search
                </Link>
            ...
            {usersQuery.isError && (
              <p
                ...
                role="alert"
              >
                Could not load the users. The server may
                be unavailable.
              </p>
            )}
            ...
            {!usersQuery.isPending &&
              !usersQuery.isError && (
                <>
                  ...
                  {usersQuery.isFetching && (
                    <p
                      className="user-list-card__updating"
                      role="status"
                    >
                      Updating users...
                    </p>
