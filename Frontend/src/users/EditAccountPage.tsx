...
export function EditAccountPage() {
  ...
  if (currentUserQuery.isPending) {
    return (
      <main className="edit-account-status">
        <p className="edit-account-status__message">
          Loading account...
        </p>
      </main>
    );
  ...
  return (
    <main className="edit-account-page">
      <section className="edit-account-page__intro">
        ...
        <p className="edit-account-page__intro-text">
          Update the name and email address associated with your account.
        </p>

        <Link className="edit-account-page__back-link" to="/account">
          Back to account
        </Link>
      </section>

      <section className="edit-account-page__content">
        <span
          className="edit-account-page__connector"
          aria-hidden="true"
        >
          <span className="edit-account-page__connector-line" />
          <span className="edit-account-page__connector-dot" />
        </span>

        <article className="edit-account-card">
          <header className="edit-account-card__header">
            <p className="edit-account-card__eyebrow">
              Personal details
            </p>
          ...
          >
            ...
            <div
              className="edit-account-form__messages"
              aria-live="polite"
            >
              {formError && (
                <p className="form-message form-message--error">
          ...
          <section className="edit-account-danger">
            <div>
              <p className="edit-account-danger__eyebrow">
                Danger zone
              </p>
              ...
              <p>
                Permanently remove this account and its associated data.
              </p>
            </div>
