...
namespace PersonalSite.Api.Tests.IntegrationTests.Application.Users
    .GetUserSummeries;
...
public class GetUserSummariesTests : IntegrationTest
{
    ...
    public async Task GetUserSummaries()
    {
        ...
        var result =
            await response.ReadJsonAs<GetUserSummariesResponse>(
                HttpStatusCode.OK);
    ...
    [Fact]
    public async Task GetUserSummariesAsRegularUserReturnsOnlyFakeUsers()
    {
        await AuthenticateAsUser(
            UserRole.User);
            ...
            db =>
            {
                db.Users.AddRange(
                    ...
                    new User
                    {
                        ...
                        Email =
                            new UserEmail(
                                "george.orwell@email.com")
                    });
            });

        var response =
            await Client.GetAsync(
                "/users?search=email&page=2&pageSize=1");
    ...
    [Fact]
    public async Task GetUserSummariesSearchForNoResults()
    {
        await AuthenticateAsUser(
            UserRole.Administrator);
        ...
        var response =
            await Client.GetAsync(
                "/users?search=Commits&page=2&pageSize=1");
